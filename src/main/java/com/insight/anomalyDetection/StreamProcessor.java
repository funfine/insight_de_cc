 ...
 * This is the entry point for the application. Input and output filenames can be taken as command-line arguments. Otherwise, it is the default name specified in the README.
 * First line from the batch file is read first to determine D and T.
 * Initial file is then read to build the socialGraph consisted of all users, relationships, and purchase history.
 * The event in the stream file is processed as a stream, i.e, each event will update the socialGraph in real time.
 */
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(args.length > 0) {
            if (args.length == 3) {
                ...
                log.error("Proper Usage is: java program initialfile streamfile outputfile");
            }
        }
        ...
        try {
            ...
            switch (eventType) {
                ...
                case purchase:
                    ...
                    UserOperations.INSTANCE.addPurchase(socialGraph, purchaseRecord, flagStream);
                    break;
                ...
                case befriend:
                    ...
                    UserOperations.INSTANCE.addFriend(socialGraph, id1, id2, flagStream);
                    break;
                ...
                case unfriend:
                    ...
                    UserOperations.INSTANCE.removeFriend(socialGraph, id1, id2, flagStream);
                    break;
            }
        } catch (IOException e) {
